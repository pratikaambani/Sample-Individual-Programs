...
public class FOStreamAndByteArrayOS {
	...
	public static void main(String args[]) {
		...
		try {
			FileOutputStream fOS1 = new FileOutputStream("C://test1.txt");
			FileOutputStream fOS2 = new FileOutputStream("C://test2.txt");
		...
		try {
			FileInputStream fIN1 = new FileInputStream("C://test1.txt");
			FileInputStream fIN2 = new FileInputStream("C://test2.txt");
			FileInputStream fIN3 = new FileInputStream("C://test1.txt");
